...
namespace PlasticStore.Areas.Admin.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "nameProduct,idProduct,price,description,idType")] Product product, HttpPostedFileBase img1, HttpPostedFileBase img2)
        {
            if (Session["SESSION_GROUP_ADMIN"] != null)
            {
