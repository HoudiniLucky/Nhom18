...
function renderTable(dataList) {
    $(document).ready(() => {
                     ...
                     <div class="cart-product-item">
                            ...
                            <div class="item-info">
                                <div class="info-heading">
                                    ...
                                    <div class="heading-close" onclick="remove('${el['title']}',event)"><img src="//theme.hstatic.net/200000321771/1000699946/14/ic_close.png?v=305"></div>
                                </div>
                                <div class="info-price">${el['price']},000 VND</div>
                                <div class="info-total">
                                    <div class="total-amount">
                                        <button class="button-amount button-minus" onclick="clickMinus('${el['title']}',event)"/>-</button>
                                        <input type="number" class="input-amout" readonly min="1" value="${el['amount']}" />
                                        <button class="button-amount button-add" onclick="clickAdd('${el['title']}',event)">+</button>
                                    </div>
        ...
        if (count > 0) {
            ...
            let emp = <div class="empty-cart">Chưa có sản phẩm trong giỏ</div>
            $('#renderBody').html(emp);
